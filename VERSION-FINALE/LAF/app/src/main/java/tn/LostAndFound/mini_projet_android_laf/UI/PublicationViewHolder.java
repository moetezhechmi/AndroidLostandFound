...
import tn.LostAndFound.mini_projet_android_laf.models.UserItemModel;

public class PublicationViewHolder extends RecyclerView.ViewHolder {
    ImageView ivPublication, ivLike, ivCommentaire,ivDelete,iv_sendHome;
    ...
    public PublicationViewHolder(@NonNull View itemView) {
        ...
        iv_sendHome = itemView.findViewById(R.id.iv_sendHome);
    ...
    public void bind(Publication publication,Context context) {
        ...
        iv_sendHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent= new Intent(context, ChatFromPubActivity.class);
