...
public class MesPublicationsAdapter extends RecyclerView.Adapter<MesPublicationViewHolder> {
    List<Publication> publications= new ArrayList<>();
    Retrofit retrofitClient = RetrofitClient.getInstance();
    Service service = retrofitClient.create(Service.class);
    Context context;
    public MesPublicationsAdapter(Context context) {
    ...
    @NonNull
    @Override
    public MesPublicationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_mes_publications, parent, false);
        return new MesPublicationViewHolder(view);

    }

    @Override
    public void onBindViewHolder(@NonNull MesPublicationViewHolder holder, int position) {
